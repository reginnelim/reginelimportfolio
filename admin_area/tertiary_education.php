...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql="UPDATE `educ` SET `school`='$school',`descrip`='$descrip',`address`='$address',`year`='$year' WHERE `educnum`='1'";
            ...
            <div data-aos="flip-left" class="row justify-content-center mt-5">
                <div class="col-md-6">
                    <div class="card shadow bg-purple">
                        <div class="card-body">
                            <h2 class="cookie-regular text-center text-color-yellow">Tertiary Education Details</h2>
                            <h1 class="acme-regular text-center text-color-green">Education Information</h1>
                            <form method="post">
                                <div class="mb-3">
                                    <label class="form-label">Course</label>
                                    <input type="text" class="form-control" value="<?php echo $roweduc["descrip"] ?>" name="descrip" required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Name of School</label>
                                    <input type="text" class="form-control" value="<?php echo $roweduc["school"] ?>" name="school" required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">School Address</label>
                                    <input type="text" class="form-control" value="<?php echo $roweduc["address"] ?>" name="address" required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Year Graduated</label>
                                    <input type="text" class="form-control" value="<?php echo $roweduc["year"] ?>" name="year" required>
                                </div>
