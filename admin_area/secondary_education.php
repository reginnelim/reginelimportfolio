...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql="UPDATE `educ` SET `school`='$school',`address`='$address',`year`='$year' WHERE `educnum`='2'";
    ...
    $queryeduc = "select * from educ where educnum=2";
...
<html lang="en">
  <head>
    ...
    <title>Edit secondary education</title>
            ...
            <div data-aos="flip-left" class="row justify-content-center mt-5">
                <div class="col-md-6">
                    <div class="card shadow bg-purple">
                        <div class="card-body">
                            <h2 class="cookie-regular text-center text-color-yellow">Secondary Education Details</h2>
