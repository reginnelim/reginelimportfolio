...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql="UPDATE `about` SET `name`='$fullname',`address`='$address',`email`='$email',`contactnum`='$contactnum'";
    ...
    <section id="home" class="bg-pinkish-white" style="padding-top: 0;">
        ...
        <div class="container">
            <div data-aos="flip-left" class="row justify-content-center mt-5">
                <div class="col-md-6">
                    <div class="card shadow bg-light-green">
                        <div class="card-body">
                            <h2 class="cookie-regular text-center text-color-yellow">Update Your Personal Data</h2>
                            <h1 class="acme-regular text-center text-color-green">Personal Information</h1>
                            <form method="post">
                                <div class="mb-3">
                                    <label class="form-label">Full Name</label>
                                    <input type="text" class="form-control" name="fullname" value="<?php echo $row["name"] ?>" required></input>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="tel" class="form-control" value="<?php echo $row["contactnum"] ?>" name="contactnum" required>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn bg-yellow w-50 text-white" name="submit">Update Data</button>
                                </div>
                            </form>
                        </div>
                    </div>
