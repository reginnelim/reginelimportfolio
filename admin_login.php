    ...
    <section id="home" class="bg-pinkish-white" style="padding-top: 0;">
        ...
        <div class="container">
            <div data-aos="flip-left" class="row justify-content-center mt-5">
                <div class="col-md-6">
                    <div class="card shadow py-4 bg-purple mt-5">
                        <div class="card-body">
                            <h2 class="cookie-regular text-center text-color-yellow">Login</h2>
                            <h1 class="acme-regular text-center text-color-green">Welcome Back!</h1>
                            <form method="post" action="login.php">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn bg-yellow w-50 text-white" name="submit">Login</button>
                                </div>
                            </form>
                        </div>
                    </div>
