    ...
    <section id="home" class="bg-pinkish-white" style="padding-top: 0;">
        ...
        <div class="container">
            <div data-aos="flip-left" class="row justify-content-center mt-5">
                <div class="col-md-6">
                    <div class="card shadow bg-pink">
                        <div class="card-body">
                            <h2 class="cookie-regular text-center text-color-yellow">Graphic Work</h2>
                            <h1 class="acme-regular text-center text-color-green">Edit Graphic Work</h1>
                            <form enctype="multipart/form-data" action="upload_graphic_work.php?id=<?php echo $id; ?>" method="post">
                                <?php if(isset($_GET['error'])){ ?>
                                    <p class="error"><?php echo $_GET['error']; ?></p>
                                <?php }?>
                                <div class="mb-3">
                                    <label class="form-label">Select Graphic File</label>
                                    <input type="file" class="form-control" accept="image/*" name="my_image" required>
                                </div>
                                <div class="text-center">
                                    <button type="submit" class="btn bg-yellow w-50 text-white" name="submit">Save Changes</button>
                                </div>
                            </form>
                        </div>
                    </div>
