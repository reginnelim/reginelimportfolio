...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql="INSERT INTO `work`(`jobtitle`, `title`, `address`, `year`) VALUES ('$jobtitle','$title','$address','$year')";
            ...
            <div data-aos="flip-left" class="row justify-content-center mt-5">
                <div class="col-md-6">
                    <div class="card shadow bg-purple">
                        <div class="card-body">
                            <h2 class="cookie-regular text-center text-color-yellow">Add Work Experience</h2>
                            <h1 class="acme-regular text-center text-color-green">Work Experience Information</h1>
                            <form method="post">
                                <div class="mb-3">
                                    <label class="form-label">Position</label>
                                    <input type="text" class="form-control" placeholder="Enter your position" name="jobtitle" required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Company Name</label>
                                    <input type="text" class="form-control" placeholder="Enter the company name" name="title" required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Company Address</label>
                                    <input type="text" class="form-control" placeholder="Enter the company address" name="address" required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Employment Period</label>
                                    <input type="text" class="form-control" placeholder="Enter the employment period" name="year" required>
                                </div>
                                <div class="text-center">
                                    <button type="submit" class="btn bg-yellow w-50 text-white" name="submit">Add Experience</button>
                                </div>
                            </form>
                        </div>
                    </div>
