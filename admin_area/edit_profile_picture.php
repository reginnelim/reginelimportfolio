            ...
            <div data-aos="flip-left" class="row justify-content-center mt-5">
                <div class="col-md-6">
                    <div class="card bg-blue">
                        <div class="card-body">
                            <h2 class="cookie-regular text-center text-color-yellow">Change Profile Picture</h2>
                            <h1 class="acme-regular text-center text-color-green">Profile Picture Upload</h1>
                            <form enctype="multipart/form-data" action="upload_profile_pic.php" method="post">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn bg-yellow w-50 text-white" name="submit" value="Upload">Change Profile Picture</button>
                                </div>
                            </form>
                        </div>
                    </div>
